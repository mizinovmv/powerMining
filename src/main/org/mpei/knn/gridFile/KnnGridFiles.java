...
public class KnnGridFiles extends AbstractJob {

	private static final Logger log = LoggerFactory
			.getLogger(KnnGridFiles.class);
	...
	public static void main(String[] args) throws Exception {
		while (NN < 146) {
			ToolRunner.run(new Configuration(), new KnnGridFiles(), args);
			++NN;
		}
	}
	...
	public int run(String[] args) throws Exception {
		...
		addOption(KnnGridFiles.TOKEN_CASHE, "tc",
				"Path with token's vocabulary.", "knnAnalyzer/part-r-00000");
		addOption(KnnGridFiles.TRAIN, "t", "Path with train data.",
				"classes");
		addOption(KnnGridFiles.NEIGHBORS, "nn",
